  ...
  return (
    <div className="hidden md:flex md:w-[45%] bg-[var(--color-mkt-dark)] flex-col justify-center items-center px-[var(--spacing-12)] py-[var(--spacing-16)]">
      <div className="max-w-sm text-center">
        <h1 className="font-[family-name:var(--font-display)] text-2xl font-medium tracking-[0.12em] uppercase text-[var(--color-mkt-text-inverse)]">
          Modern{" "}
          <span className="text-[var(--color-mkt-accent)]">Signal</span>{" "}
          Advisory
        </h1>
        <p className="font-[family-name:var(--font-body)] text-lg text-[var(--color-mkt-text-inverse)]/70 mt-[var(--spacing-3)]">
          The Intelligence Era of Real Estate
        </p>
        <div className="w-16 h-0.5 bg-[var(--color-mkt-accent)] mx-auto mt-[var(--spacing-6)]" />
        <p className="font-[family-name:var(--font-body)] text-lg text-[var(--color-mkt-text-inverse)]/50 mt-[var(--spacing-8)] leading-relaxed">
...
export function MobileBrandHeader() {
  return (
    <div className="md:hidden bg-[var(--color-mkt-dark)] px-[var(--spacing-6)] py-[var(--spacing-6)] text-center">
      <h1 className="font-[family-name:var(--font-display)] text-lg font-medium tracking-[0.12em] uppercase text-[var(--color-mkt-text-inverse)]">
        Modern{" "}
        <span className="text-[var(--color-mkt-accent)]">Signal</span>{" "}
        Advisory
      </h1>
