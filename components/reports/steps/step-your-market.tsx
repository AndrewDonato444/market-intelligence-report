...
export function StepYourMarket({
  ...
  return (
    <div className="py-4">
      ...
      {markets.length > 0 && (
        <div className="mb-6">
          <p className="font-[family-name:var(--font-sans)] text-xs font-medium uppercase tracking-wide text-[var(--color-text-tertiary)] mb-3">
            Saved Markets
          </p>
              ...
              >
                ...
                {onQuickStart && (
                  <button
                    ...
                    className="mt-1 px-3 py-1 text-xs font-semibold bg-[var(--color-accent)] text-[var(--color-primary)] rounded-[var(--radius-sm)] hover:bg-[var(--color-accent-hover)] transition-colors duration-[var(--duration-default)]"
                  >
                    Use This
                  </button>
                )}
          ...
          <div className="flex items-center gap-3 mt-2">
            ...
            <span className="font-[family-name:var(--font-sans)] text-xs font-medium text-[var(--color-text-secondary)] whitespace-nowrap">
      ...
      <div className="mb-4">
        ...
        />
        <p className="mt-2 flex items-center gap-1.5 font-[family-name:var(--font-sans)] text-xs text-[var(--color-text-secondary)]">
